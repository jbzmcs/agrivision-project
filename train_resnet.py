...
NUM_CLASSES = 4       # Corrected based on your file tree
BATCH_SIZE = 32
NUM_EPOCHS = 10
LEARNING_RATE = 0.001
# ---------------------------------------
...
def main():
    ...
    print("\n--- Final Model Evaluation (Objective 4 Data) ---")
    model.eval()
    ...
    print("\nClassification Report (ResNet50):") # <-- CHANGED
    report = classification_report(all_labels, all_preds, target_names=class_names, digits=4)
    print(report)
    
    print("\nConfusion Matrix (ResNet50):") # <-- CHANGED
    ...
    print("Objective 3: ResNet50 training and evaluation complete.")
