...
MODEL_SAVE_PATH = 'models/resnet50_overfit.pth' 
...
def print_config():
    ...
    """
    print("\n--- Configuration (ResNet50 Overfit Experiment) ---")
...
def main():
    """
    Orchestrates the training and validation process for the overfit experiment.
    """
    print(f"Starting ResNet50 OVERFIT Experiment")
    ...
    print("\nResNet50 OVERFIT experiment complete.")
