import torch
from train_plant_conv import config, create_next_folder, select_model
...
def load_dataset(input_size=(224,224), batch_size=16,
...
if __name__ == "__main__":
    ...
    test_model(
        test_loader,
        model_path = "./runs/train_10/best_model.pt",
        num_classes=10,
    )
