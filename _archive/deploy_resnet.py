...
# --- FIXED: Paths are relative to the project root ---
model_path = "models/resnet50_best_p15.pth" # <-- Our Champion ResNet
# ----------------------------------------------------

NUM_CLASSES = 10 

# --- NEW: Define the save directory ---
SAVE_BASE_DIR = os.path.join("_archive", "images", "resnet_img")
# ------------------------------------

# =========================================
# THE CORRECTED MODEL LOADING
# =========================================
print("Loading ResNet50 model blueprint...")
...
def apply_gradcam(image_path, model, device, save_dir):
    ...
    # --- FIXED: Define the target layer for ResNet50 ---
    ...
    save_filename = f"RESNET_{original_filename}_{pred_label}.jpg" # Added prefix
